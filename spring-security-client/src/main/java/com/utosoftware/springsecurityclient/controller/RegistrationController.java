...
import com.utosoftware.springsecurityclient.event.RegistrationCompleteEventBuilder11;
import com.utosoftware.springsecurityclient.model.PasswordModel;
...
public class RegistrationController {
    ...
    public String registerUser(@RequestBody UserModel userModel, final HttpServletRequest request){
        ...
        publisher.publishEvent(new RegistrationCompleteEventBuilder11().setUser(user).setApplicationUrl(applicationUrl(request)).createRegistrationCompleteEvent());
        return "Success";
    }
    ...
    private String passwordResetTokenMail(User user, String applicationUrl, String token) {
        ...
        log.info("당신의 계정을 Reset 하기위해 링크를 클릭하세요:{}",url);
        return url;
    }
